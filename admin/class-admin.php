...
class Admin
{
	...
	protected static function assistant_steps()
	{
		return array(
			...
			'visibility' => array('number' => 7, 'title' => __('Visibilidad IA', 'ai-knowledge'), 'description' => __('Decide qué familias de crawlers pueden acceder al sitio y cómo se gestiona su acceso a llms.txt. Las reglas de robots.txt y .htaccess se revisan antes de aplicarlas y permiten conservar una copia de seguridad para poder recuperar la configuración anterior.', 'ai-knowledge'), 'link' => admin_url('admin.php?page=ai-knowledge&tab=visibilidad-ia')),
