...
if ( ! $genix_ready ) :
	?>
	<p style="color:#b32d2e;"><?php esc_html_e( 'Support Genix no está activo o su módulo de Knowledge Base todavía no se ha cargado. No se puede sincronizar ahora mismo.', 'ai-knowledge' ); ?></p>
<?php else : ?>
