...
class Plugin {
	...
	public function init() {
		...
		require_once AIKB_DIR . 'includes/class-genix-bridge.php';
		require_once AIKB_DIR . 'includes/class-document-pipeline.php';
		require_once AIKB_DIR . 'includes/class-store-info-doc.php';
		require_once AIKB_DIR . 'includes/class-llms-faq.php';
		require_once AIKB_DIR . 'includes/class-queue.php';
		require_once AIKB_DIR . 'includes/class-llms-txt.php';
		require_once AIKB_DIR . 'includes/class-rest-guard.php';
		require_once AIKB_DIR . 'includes/class-rest-content.php';
		require_once AIKB_DIR . 'includes/class-sync.php';
		require_once AIKB_DIR . 'includes/class-indexnow.php';
		require_once AIKB_DIR . 'includes/class-doc-redirect.php';
		require_once AIKB_DIR . 'includes/class-markdown-discovery.php';
		require_once AIKB_DIR . 'includes/class-markdown-server.php';
		require_once AIKB_DIR . 'includes/class-chatbot-language-fix.php';
		require_once AIKB_DIR . 'includes/class-chatbot-prompt.php';
		require_once AIKB_DIR . 'includes/class-chatbot-prompt-builder.php';
		require_once AIKB_DIR . 'includes/class-chatbot-relevance-guard.php';
		require_once AIKB_DIR . 'includes/class-genix-hooks-guard.php';
		require_once AIKB_DIR . 'includes/class-crawler-catalog.php';
		...
		add_action( 'init', array( '\AIKB\Rest_Guard', 'init' ), 20 );

		add_action( 'init', array( __CLASS__, 'register_rewrite' ) );
		add_filter( 'query_vars', array( '\AIKB\Llms_Txt', 'register_query_var' ) );
		add_action( 'parse_request', array( '\AIKB\Llms_Txt', 'maybe_serve' ) );

		if ( is_admin() ) {
			require_once AIKB_DIR . 'admin/class-admin.php';
			Admin::init();
